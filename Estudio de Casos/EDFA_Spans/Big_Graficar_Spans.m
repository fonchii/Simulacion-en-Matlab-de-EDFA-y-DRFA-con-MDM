...
ModoS = ["01" "11_a"];%["01" "11_a" "21_a"];
modos_LP = ["LP_01" "LP_11_a"];%["LP_01" "LP_11_a" "LP_21_a"];
...
xlabel(ax4,'Fibra [km]',"FontSize",18)
ylim(ax4,[ymin ymax])
legend('Location', 'southoutside','Orientation','horizontal','Box','off', "NumColumns" , 3,"FontSize",13)
...
title(t,'Propagación de Señal a 1555 nm',"FontSize",18)
ylabel(t,'Potencia [dBm]',"FontSize",16)
