...
z = Span.EDFA1.Nucleo1.z; Nspans = 3; LargoFibra = 40;
...
% LP11a
fibra1_01 = [Amp1.LP_11_a(:,end) Amp2.LP_11_a(:,1)];
fibra2_01 = [Amp2.LP_11_a(:,end) Amp3.LP_11_a(:,1)];
fibra3_01 = [Amp3.LP_11_a(:,end) Amp4.LP_11_a(:,1)];

% LP21a
fibra1_21 = [Amp1.LP_21_a(:,end) Amp2.LP_21_a(:,1)];
fibra2_21 = [Amp2.LP_21_a(:,end) Amp3.LP_21_a(:,1)];
fibra3_21 = [Amp3.LP_21_a(:,end) Amp4.LP_21_a(:,1)];

% LP02
fibra1_02 = [Amp1.LP_02(:,end) Amp2.LP_02(:,1)];
fibra2_02 = [Amp2.LP_02(:,end) Amp3.LP_02(:,1)];
fibra3_02 = [Amp3.LP_02(:,end) Amp4.LP_02(:,1)];
z_fibra = [0 40]; lambdas = Span.EDFA4.Nucleo1.signal.lambdas.*1e9;

ymin = -10 ; ymax = 15;

% Grafico 1 - EDFA 1
ax1 = axes(t);
plot(ax1,z,Amp1.LP_11_a(26,:) , "DisplayName","Modo LP11a") ; hold on
plot(ax1,z,Amp1.LP_21_a(26,:) , "DisplayName","Modo LP21a") ; 
plot(ax1,z,Amp1.LP_02(26,:) , "DisplayName","Modo LP02") ; 
% plot(ax1,z,Amp1.LP_11_a(1,:) , "DisplayName",strcat(num2str(lambdas(1))," nm")) ; hold on
% plot(ax1,z,Amp1.LP_11_a(21,:) , "DisplayName",strcat(num2str(lambdas(21)), " nm"))
% plot(ax1,z,Amp1.LP_11_a(31,:) , "DisplayName",strcat(num2str(lambdas(31)), " nm"))
xline(ax1,3,':');
ax1.Box = 'off';
xlim(ax1,[0 3])
xlabel(ax1, 'EDFA 1 [m]')
...
ax3 = axes(t);
ax3.Layout.Tile = 3;
plot(ax3,z,Amp2.LP_11_a(26,:)) ; hold on
plot(ax3,z,Amp2.LP_21_a(26,:)) ;
plot(ax3,z,Amp2.LP_02(26,:)) ;
% plot(ax3,z,Amp2.LP_11_a(1,:)) ; hold on
% plot(ax3,z,Amp2.LP_11_a(21,:))
% plot(ax3,z,Amp2.LP_11_a(31,:))
xline(ax3,0,':');
xline(ax3,3,':');
...
ax4 = axes(t);
ax4.Layout.Tile = 4;
plot(ax4,z_fibra,fibra2_01(26,:) , "DisplayName","Modo LP11a") ; hold on
plot(ax4,z_fibra,fibra2_21(26,:) , "DisplayName","Modo LP21a") ;
...
ax5 = axes(t);
ax5.Layout.Tile = 5;
plot(ax5,z,Amp3.LP_11_a(26,:)) ; hold on
plot(ax5,z,Amp3.LP_21_a(26,:)) ;
plot(ax5,z,Amp3.LP_02(26,:)) ;
% plot(ax5,z,Amp3.LP_11_a(1,:)) ; hold on
% plot(ax5,z,Amp3.LP_11_a(21,:))
% plot(ax5,z,Amp3.LP_11_a(31,:))
xline(ax5,0,':');
xline(ax5,3,':');
...
ax7 = axes(t);
ax7.Layout.Tile = 7;
plot(ax7,z,Amp4.LP_11_a(26,:)) ; hold on
plot(ax7,z,Amp4.LP_21_a(26,:)) ;
plot(ax7,z,Amp4.LP_02(26,:)) ;
% plot(ax7,z,Amp4.LP_11_a(1,:)) ; hold on
% plot(ax7,z,Amp4.LP_11_a(21,:))
% plot(ax7,z,Amp4.LP_11_a(31,:))
xline(ax7,0,':');
