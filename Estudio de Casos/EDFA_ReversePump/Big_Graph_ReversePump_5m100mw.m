...
%     end
%     xlabel(xlab,'FontSize',16) ; ylabel(ylab,'FontSize',16); title(strcat('Distribución Axial de la Señal LP',smodos(s)),'FontSize',18) ; 
%     legend('Location', 'southoutside','Orientation','horizontal','Box','off', "NumColumns" , 6,'FontSize', 13);
%     annotation('textbox', [0.04, 0.1595, 0, 0], 'string', 'ForwardPump','FontSize',13)
%     annotation('textbox', [0.04, 0.131, 0, 0], 'string', 'BackwardPump','FontSize',13)
%     if s == 1
%         set( gcf,'PaperSize',[29.7 21.0], 'PaperPosition',[0 0 29.7 21.0])
...
%     end
%     xlabel(xlab,'FontSize', 16) ; ylabel(ylab,'FontSize', 16); title('Distribución Axial del Bombeo','FontSize', 18) ; 
...
%      
% end
% title('Distribución Espectral de Ganancias','FontSize',18) ; xlabel('Longitud de Onda [nm]','FontSize',16) ; ylabel("Magnitud [dB]",'FontSize',16) ;
% legend('Location', 'southoutside','Orientation','horizontal','Box','off', "NumColumns" , 2,'FontSize', 13);
% 
% annotation('textbox', [0.25, 0.1595, 0, 0], 'string', 'ForwardPump','FontSize', 13)
% annotation('textbox', [0.25, 0.131, 0, 0], 'string', 'BackwardPump','FontSize', 13)
% set( gcf,'PaperSize',[29.7 21.0], 'PaperPosition',[0 0 29.7 21.0])
...
% end
% legend('Location', 'southoutside','Orientation','horizontal','Box','off', "NumColumns" , 2,'FontSize', 13)
% title(strcat('Distribución espectral de OSNR'),'FontSize', 18) ; %grid on ; 
% xlabel('Longitud de Onda [nm]','FontSize', 16) ; ylabel("Magnitud [dB]",'FontSize', 16) ; 
% annotation('textbox', [0.25, 0.1595, 0, 0], 'string', 'ForwardPump','FontSize', 13)
% annotation('textbox', [0.25, 0.131, 0, 0], 'string', 'BackwardPump','FontSize', 13)
% set( gcf,'PaperSize',[29.7 21.0], 'PaperPosition',[0 0 29.7 21.0])
...
legend('Location', 'southoutside','Orientation','horizontal','Box','off', "NumColumns" , 2,'FontSize', 13)
title('Figuras de Ruido','FontSize', 18) ; %grid on ; 
xlabel('Longitud de Onda [nm]','FontSize', 16) ; ylabel("Magnitud [dB]",'FontSize', 16) ; 
annotation('textbox', [0.25, 0.1595, 0, 0], 'string', 'ForwardPump','FontSize', 13)
annotation('textbox', [0.25, 0.131, 0, 0], 'string', 'BackwardPump','FontSize', 13)
set( gcf,'PaperSize',[29.7 21.0], 'PaperPosition',[0 0 29.7 21.0])
