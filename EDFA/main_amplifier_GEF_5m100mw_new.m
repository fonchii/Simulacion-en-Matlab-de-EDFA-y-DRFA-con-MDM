...
Fibra.SigmaSpectrum = "OptiSystem"; % "OptiSystem"
Fibra.n1 = 1.45 ;   
Fibra.n2 = 1.4354 ;
...
for s = 1:length(Signal.modos)
    ...
    xlabel('Longitud de onda [nm]','FontSize',16); ylabel('Ganancia [dB]','FontSize',16) %xlabel('λ [nm]') 
...
% set( gcf,'Units','centimeters','PaperSize',[29.7 21.0], 'PaperPosition',[0 0 29.7 21.0])
