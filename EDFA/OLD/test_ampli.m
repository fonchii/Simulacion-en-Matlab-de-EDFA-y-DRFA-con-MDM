...
signal.modos = ["01" "11" "11_a"] ;

signal.lambda.LP_01 = [1550e-9 1540e-9 1560e-9];                        P0_signal.LP_01 = [-15 -15 -15];
signal.lambda.LP_11_a = [1550e-9];                      P0_signal.LP_11_a = [-15 -15 -15];
...
fibra.largo = 5; fibra.radio = 15e-6 ; fibra.N = 7e24; % fibra.N = 3e24; 
fibra.AN = 0.2 ; fibra.n1 = 1.45 ; fibra.n2 = sqrt((fibra.n1^2-fibra.AN^2));
fibra.M = 20; fibra.Nalpha = 1.94;
