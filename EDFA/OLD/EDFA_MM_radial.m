                    ...
                    for s = 1:1:Smod
                        ...
                        if(z == 1)
                            for i = 1:1:Nwl
                                ...
                                for m = 1:fibra.M-1
                                    if m == 1
                                        Psp.(strcat("LP_",signal.modos(s)))(i,z) = Ps0 + (N2(z,m)*sigma_ems(lambda_s(i))-N1(z,m)*sigma_abs(lambda_s(i)))*Gamma_s*Ps0*del_z/(1+Ps0/Psat);
                                    else
                                        Psp.(strcat("LP_",signal.modos(s)))(i,z) = Psp.(strcat("LP_",signal.modos(s)))(i,z) + (N2(z,m)*sigma_ems(lambda_s(i))-N1(z,m)*sigma_abs(lambda_s(i)))*Gamma_s*Ps0*del_z/(1+Ps0/Psat);
                                    end
                                end
                            end
                        else
                            for i = 1:1:Nwl
                                ...
                                for m = 1:fibra.M-1
                                    if m == 1
                                        ...
                                        Psp.(strcat("LP_",signal.modos(s)))(i,z) = Psp.(strcat("LP_",signal.modos(s)))(i,z) + (N2(z,m)*sigma_ems(lambda_s(i))-N1(z,m)*sigma_abs(lambda_s(i)))*Gamma_s*Psp.(strcat("LP_",signal.modos(s)))(i,z-1)*del_z/(1+Psp.(strcat("LP_",signal.modos(s)))(i,z-1)/Psat);
                                    end
                                end
                            end
                        end
                    ...
                    for s = 1:1:Smod
                        ...
                        if(z == 1)
                            for i = 1:1:Nwl
                                ...
                                for m = 1:fibra.M-1
                                    if m == 1
                                        Pap.(strcat("LP_",signal.modos(s)))(i,z) = P_ase0 + ((N2(z,m)*sigma_ems(lambda_s(i))-N1(z,m)*sigma_abs(lambda_s(i)))*Gamma_s*P_ase0 + 2*N2(z,m)*sigma_ems(lambda_s(i))*Gamma_s*h*v_s(i)*d_vk)*del_z/(1+P_ase0/Psat);
                                    else
                                        Pap.(strcat("LP_",signal.modos(s)))(i,z) = Pap.(strcat("LP_",signal.modos(s)))(i,z) + ((N2(z,m)*sigma_ems(lambda_s(i))-N1(z,m)*sigma_abs(lambda_s(i)))*Gamma_s*P_ase0 + 2*N2(z,m)*sigma_ems(lambda_s(i))*Gamma_s*h*v_s(i)*d_vk)*del_z/(1+P_ase0/Psat);
                                    end
                                end
                            end
                        else
                            for i = 1:1:Nwl
                                ...
                                for m = 1:fibra.M-1
                                    if m == 1
                                        ...
                                        Pap.(strcat("LP_",signal.modos(s)))(i,z) =Pap.(strcat("LP_",signal.modos(s)))(i,z) + ((N2(z,m)*sigma_ems(lambda_s(i))-N1(z,m)*sigma_abs(lambda_s(i)))*Gamma_s*Pap.(strcat("LP_",signal.modos(s)))(i,z-1) + 2*N2(z,m)*sigma_ems(lambda_s(i))*Gamma_s*h*v_s(i)*d_vk)*del_z/(1+Pap.(strcat("LP_",signal.modos(s)))(i,z-1)/Psat);
                                    end
                                end
                            end
                        end
                            ...
                            for i = 1:1:Nwl
                                ...
                                for m = 1:fibra.M-1
                                    if m == 1
                                        ...
                                        Pan.(strcat("LP_",signal.modos(s)))(i,Nz-z+1) = Pan.(strcat("LP_",signal.modos(s)))(i,Nz-z+1)+((N2(Nz-z+1,m)*sigma_ems(lambda_s(i))-N1(Nz-z+1,m)*sigma_abs(lambda_s(i)))*Gamma_s*0 + 2*N2(Nz-z+1,m)*sigma_ems(lambda_s(i))*Gamma_s*h*v_s(i)*d_vk)*del_z;
                                    end
                                end
                            end
                        else
                            for i = 1:1:Nwl
                                ...
                                for m = 1:fibra.M-1
                                    if m == 1
                                        ...
                                        Pan.(strcat("LP_",signal.modos(s)))(i,Nz-z+1) = Pan.(strcat("LP_",signal.modos(s)))(i,Nz-z+1) + ((N2(Nz-z+1,m)*sigma_ems(lambda_s(i))-N1(Nz-z+1,m)*sigma_abs(lambda_s(i)))*Gamma_s*Pan.(strcat("LP_",signal.modos(s)))(i,Nz-z+1+1) + 2*N2(Nz-z+1,m)*sigma_ems(lambda_s(i))*Gamma_s*h*v_s(i)*d_vk)*del_z/(1+Pan.(strcat("LP_",signal.modos(s)))(i,Nz-z+1+1)/Psat);
                                    end
                                end
            ...
            for w = 1:1:Nwl
                ...
                if(z == 1)
                    for i = 1:1:Nch_ase
                        for m = 1:fibra.M-1
                            if m == 1
                                Pap_sp.(strcat("LP_",signal.modos(s)))(i,z) = P_ase0_sp + ((N2(z,m)*sigma_ems(lambda_ase(i))-N1(z,m)*sigma_abs(lambda_ase(i)))*Gamma_s*P_ase0_sp + 2*N2(z,m)*sigma_ems(lambda_ase(i))*Gamma_s*h*v_s_sp(i)*d_vk)*del_z/(1+P_ase0_sp/Psat);
                            else
                                Pap_sp.(strcat("LP_",signal.modos(s)))(i,z) = Pap_sp.(strcat("LP_",signal.modos(s)))(i,z) + ((N2(z,m)*sigma_ems(lambda_ase(i))-N1(z,m)*sigma_abs(lambda_ase(i)))*Gamma_s*P_ase0_sp + 2*N2(z,m)*sigma_ems(lambda_ase(i))*Gamma_s*h*v_s_sp(i)*d_vk)*del_z/(1+P_ase0_sp/Psat);
                            end
                        end
                    end
                else
                    for i = 1:1:Nch_ase
                        for m = 1:fibra.M-1
                            if m == 1
                                Pap_sp.(strcat("LP_",signal.modos(s)))(i,z) = Pap_sp.(strcat("LP_",signal.modos(s)))(i,z-1) + ((N2(z,m)*sigma_ems(lambda_ase(i))-N1(z,m)*sigma_abs(lambda_ase(i)))*Gamma_s*Pap_sp.(strcat("LP_",signal.modos(s)))(i,z-1) + 2*N2(z,m)*sigma_ems(lambda_ase(i))*Gamma_s*h*v_s_sp(i)*d_vk)*del_z/(1+Pap_sp.(strcat("LP_",signal.modos(s)))(i,z-1)/Psat);
                            else
                                Pap_sp.(strcat("LP_",signal.modos(s)))(i,z) = Pap_sp.(strcat("LP_",signal.modos(s)))(i,z) + ((N2(z,m)*sigma_ems(lambda_ase(i))-N1(z,m)*sigma_abs(lambda_ase(i)))*Gamma_s*Pap_sp.(strcat("LP_",signal.modos(s)))(i,z-1) + 2*N2(z,m)*sigma_ems(lambda_ase(i))*Gamma_s*h*v_s_sp(i)*d_vk)*del_z/(1+Pap_sp.(strcat("LP_",signal.modos(s)))(i,z-1)/Psat);
                            end
                        end
                    end
                end
                ...
                for i = 1:1:Nch_ase
                    for m = 1:fibra.M-1
                        if m == 1
                            ...
                            Pan_sp.(strcat("LP_",signal.modos(s)))(i,Nz-z+1) = Pan_sp.(strcat("LP_",signal.modos(s)))(i,Nz-z+1)+((N2(Nz-z+1,m)*sigma_ems(lambda_ase(i))-N1(Nz-z+1,m)*sigma_abs(lambda_ase(i)))*Gamma_s*0 + 2*N2(Nz-z+1,m)*sigma_ems(lambda_ase(i))*Gamma_s*h*v_s_sp(i)*d_vk)*del_z;
                        end
                    end
                end
            else
