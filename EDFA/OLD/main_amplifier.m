...
signal.lambda.LP_11_a   = [1520e-9:2.5e-9:1570e-9];                 P0_signal.LP_11_a   = -15*ones(1,length(signal.lambda.LP_11_a));
...
tic;
%EDFA = EDFA_MMv2(fibra,signal,pump,ASE); %21.45s
%EDFA = EDFA_MM_radial(fibra,signal,pump,ASE); %242.28 segundos
EDFA = EDFA_MM_radialv2(fibra,signal,pump,ASE); %197.82 segundos
