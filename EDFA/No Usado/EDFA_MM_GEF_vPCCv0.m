    ...
    for Q = 1:QQ
        if (Q == 1) % Primera iteracion no calcula ASE en direccion -z
            ...
            for z = 1:1:Nz %Iteraciones a lo largo del EDFA
                ...
                if (z == round(Nz/2,0) ) % Centro de la fibra
                    for s = 1:1:Smod
%                         MeanPot.(ModoS(s)) = sum( Psp.(ModoS(s))(:,z-1) ) / length(Signal.lambda.(ModoS(s)));
%                         Psp.(ModoS(s))(:,z-1) = MeanPot.(ModoS(s));
%                         MeanASE.(ModoS(s)) = sum( Pap.(ModoS(s))(:,z-1) ) / length(Signal.lambda.(ModoS(s)));
%                         Pap.(ModoS(s))(:,z-1) = MeanASE.(ModoS(s));
                        lambda_s = Signal.lambda.(ModoS(s)).*1e9;
                        for i = 1:1:length(lambda_s)
                            %if lambda_s(i)>1531*1e-9 && lambda_s(i)<1535*1e-9
                            if round(lambda_s(i),0) == 1532
                                Psp.(ModoS(s))(i,z-1) = 0.9*Psp.(ModoS(s))(i,z-1);
                            elseif round(lambda_s(i),0) == 1533
                                Psp.(ModoS(s))(i,z-1) = 0.85*Psp.(ModoS(s))(i,z-1);
                            elseif round(lambda_s(i),0) == 1534
                                Psp.(ModoS(s))(i,z-1) = 0.9*Psp.(ModoS(s))(i,z-1);

                            elseif round(lambda_s(i),0) == 1536
                                Psp.(ModoS(s))(i,z-1) = 1.08*Psp.(ModoS(s))(i,z-1);  
                            elseif round(lambda_s(i),0) == 1537
                                Psp.(ModoS(s))(i,z-1) = 1.15*Psp.(ModoS(s))(i,z-1);    
                            elseif round(lambda_s(i),0) == 1538
                                Psp.(ModoS(s))(i,z-1) = 1.2*Psp.(ModoS(s))(i,z-1);
                            elseif round(lambda_s(i),0) == 1539
                                Psp.(ModoS(s))(i,z-1) = 1.25*Psp.(ModoS(s))(i,z-1);
                            elseif round(lambda_s(i),0) == 1540
                                Psp.(ModoS(s))(i,z-1) = 1.2*Psp.(ModoS(s))(i,z-1);
                            elseif round(lambda_s(i),0) == 1541
                                Psp.(ModoS(s))(i,z-1) = 1.15*Psp.(ModoS(s))(i,z-1);
                            elseif round(lambda_s(i),0) == 1542
                                Psp.(ModoS(s))(i,z-1) = 1.1*Psp.(ModoS(s))(i,z-1);
                            elseif round(lambda_s(i),0) == 1543
                                Psp.(ModoS(s))(i,z-1) = 1.08*Psp.(ModoS(s))(i,z-1);
                            elseif round(lambda_s(i),0) == 1544
                                Psp.(ModoS(s))(i,z-1) = 1.05*Psp.(ModoS(s))(i,z-1);
                            end
                        end
                    end
                end
