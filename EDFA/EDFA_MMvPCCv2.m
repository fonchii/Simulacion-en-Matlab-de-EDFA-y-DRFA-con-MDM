function edfa = EDFA_MMvPCCv2(Fibra,Signal,Pump,ASE)
% Datos de entrada:
% signal (struct)
...
for n = 1:1:Sch     % Iteración en nucleos
    ...
    for z = 1:Nz
        for s = 1:1:Smod
            ...
            if(z == 1)
                parfor i = 1:Nch_ase
                    AuxMatrix(i) = P_ase0_sp %+ (((N2(z))*sigma_ems(lambda_ase(i)) - (N1(z))*sigma_abs(lambda_ase(i)))*Gamma_s*P_ase0_sp + 2*(N2(z))*sigma_ems(lambda_ase(i))*Gamma_s*h*v_s_sp(i)*d_vk)*del_z/(1+P_ase0_sp/Psat);
                end
%                     for i = 1:1:Nch_ase
%                         Pap_sp.(ModoS(s))(i,z) = P_ase0_sp + (((N2(z))*sigma_ems(lambda_ase(i)) - (N1(z))*sigma_abs(lambda_ase(i)))*Gamma_s*P_ase0_sp + 2*(N2(z))*sigma_ems(lambda_ase(i))*Gamma_s*h*v_s_sp(i)*d_vk)*del_z/(1+P_ase0_sp/Psat);
%                     end
...
%                         if i<Nch_ase
%                             d_vk = abs(c/lambda_ase(i) - c/lambda_ase(i+1));
%                         else
%                             d_vk = abs(c/lambda_ase(i-1) - c/lambda_ase(i));
%                         end
                    %Pap_sp.(ModoS(s))(i,z) = Pap_sp.(ModoS(s))(i,z-1) + (((N2(z))*sigma_ems(lambda_ase(i)) - (N1(z))*sigma_abs(lambda_ase(i)))*Gamma_s*Pap_sp.(ModoS(s))(i,z-1) + 2*(N2(z))*sigma_ems(lambda_ase(i))*Gamma_s*h*v_s_sp(i)*d_vk)*del_z/(1+Pap_sp.(ModoS(s))(i,z-1)/Psat);
                    AuxMatrix(i) = Pap_sp.(ModoS(s))(i,z-1) + (((N2(z))*sigma_ems(lambda_ase(i)) - (N1(z))*sigma_abs(lambda_ase(i)))*Gamma_s*Pap_sp.(ModoS(s))(i,z-1) + 2*(N2(z))*sigma_ems(lambda_ase(i))*Gamma_s*h*v_s_sp(i)*d_vk)*del_z/(1+Pap_sp.(ModoS(s))(i,z-1)/Psat);
                end
                Pap_sp.(ModoS(s))(:,z) = AuxMatrix(:) ;
            end
        end
...
%                     end
                    ...
                    %Pan_sp.(ModoS(s))(i,Nz-z+1) = Pan_sp.(ModoS(s))(i,Nz-z+1+1) + (((N2(Nz-z+1))*sigma_ems(lambda_ase(i)) - (N1(Nz-z+1))*sigma_abs(lambda_ase(i)))*Gamma_s*Pan_sp.(ModoS(s))(i,Nz-z+1+1) + 2*(N2(Nz-z+1))*sigma_ems(lambda_ase(i))*Gamma_s*h*v_s_sp(i)*d_vk)*del_z/(1+Pan_sp.(ModoS(s))(i,Nz-z+1+1)/Psat);
                    AuxMatrix(i) = Pan_sp.(ModoS(s))(i,Nz-z+1+1) + (((N2(Nz-z+1))*sigma_ems(lambda_ase(i)) - (N1(Nz-z+1))*sigma_abs(lambda_ase(i)))*Gamma_s*Pan_sp.(ModoS(s))(i,Nz-z+1+1) + 2*(N2(Nz-z+1))*sigma_ems(lambda_ase(i))*Gamma_s*h*v_s_sp(i)*d_vk)*del_z/(1+Pan_sp.(ModoS(s))(i,Nz-z+1+1)/Psat);
                end
                Pan_sp.(ModoS(s))(:,Nz-z+1) = AuxMatrix(:) ;
            end
        end
...
%                     ASE_Spectrum.(ModoS(s))(i,2) = 10*log10( Psp.(ModoS(s))(w,end) / 1e-3 );
...
% CALCULAR GRAFICO ASE SPECTRUM CON GANANCIAS DE SEÑAL v2
    ...
    sdm.(ch).z = Z;
    sdm.(ch).ASE_Spectrum.mag = ASE_SP;%ASE_Spectrum;
    sdm.(ch).ASE_Spectrum.fun = ASESpectFun;
    sdm.(ch).ASE_Spectrum.lambdas = ase_lam;%lambda_ase;
