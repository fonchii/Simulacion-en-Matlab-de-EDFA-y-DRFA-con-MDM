...
In.Pump.LP01.Powers            = [0.13677288256, 0.13489628826, 0.13489628826, 0.13489628826, 0.12445146118, 0.094406087629, 0.10375284158, 0.089125093813];                                                % [mW]
...
Nch = 100;
    % LP01  
In.Signal.LP01.Wavelengths        = linspace(1538,1620,Nch);%(1.66551366e3 , 1.50046275e3 , Nch);                  % [nm]
In.Signal.LP01.Powers             = -3.0102999566*ones( 1,length(In.Signal.LP01.Wavelengths) );                 %[dBm]
