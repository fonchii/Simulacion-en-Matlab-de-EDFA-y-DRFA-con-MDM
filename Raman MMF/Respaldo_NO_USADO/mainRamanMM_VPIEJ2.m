...
In.Fibra.Length                   = 45;                          % fibre length (km)
...
% BOMBEOS : 
    % LP01
In.Pump.LP01.Wavelengths       = [1416, 1421, 1425, 1430, 1439, 1456, 1473, 1502];                                                    % [nm]
In.Pump.LP01.PowersdBm         = [21.36 , 21.3 , 21.3 , 21.3 , 20.95 , 19.75 , 20.16 , 19.5];
In.Pump.LP01.Powers            = 1e-3.*10.^( In.Pump.LP01.PowersdBm./10 );
In.Pump.LP01.Alpha             = 0.17; 
...
In.Signal.LP01.Freqs              = linspace(1.85000000e+14 , 1.94900000e+14 , Nch);  c = 299792458;
In.Signal.LP01.Wavelengths        = (c./In.Signal.LP01.Freqs).*1e9 ;                  % [nm]
In.Signal.LP01.PowersmW           = 0.5*ones(1,Nch);
In.Signal.LP01.Powers             = 10*log10( In.Signal.LP01.PowersmW );                 %[dBm]
In.Signal.LP01.Alpha              = 0.17;                                                              % [dB/km]



In.Monomodo = true;
In.Rayleight = false; In.ase_calc = true;
