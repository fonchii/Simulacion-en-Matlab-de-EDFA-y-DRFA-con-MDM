function fmn = fmnv2(fibra,modos,modop,lambda_s,lambda_p)
% NOTA:
% las funciones de bessel se evaluan en la frecuencia normalizada de
% operacion, por lo qe para un lambda dado, el modo 01, 02 , ... son iguales.

if nargin<1
    fibra.radio=25e-6; fibra.n1=1.46; fibra.n2=1.455; modos="11"; modop= "14";
    lambda_s = 1550e-9 ; lambda_p = 1550e-9;%lambda_p = 980e-9;
end
a = fibra.radio;
if isfield(fibra,'AN')
...
l_s = str2double(extract(modos,1)); m_s = str2double(extract(modos,2));
l_p = str2double(extract(modop,1)); m_p = str2double(extract(modop,2));
